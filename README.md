...
Live Demo can be viewed at https://www.buildmyshop.com/
...
![DEMO](../master/static/images/myshop_django_demo.png)
...
* 1 - Clone project: git clone https://github.com/divanov11/myshop_django/
* 2 - cd myshop_django
